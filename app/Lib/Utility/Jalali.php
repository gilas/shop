 ...
 */
    ...
    function strtotime($time, $now = null){
        ...
        $regDateTime = '^1[0-9]{3}-[0-1]{1}[0-9]{1}-[0-3]{1}[0-9]{1} [0-9]{2}:[0-9]{2}:[0-9]{2}^';
        $regDate = '^1[0-9]{3}-[0-1]{1}[0-9]{1}-[0-3]{1}[0-9]{1}^';
        $regDateSlash = '^1[0-9]{3}/[0-1]{1}[0-9]{1}/[0-3]{1}[0-9]{1}^';
        if(preg_match($regDateTime, $time)){
        ...
        }elseif(preg_match($regDate, $time)){
            $Date = explode('-',$time);
            return self::mktime(
                0,0,0,
                $Date[1],$Date[2],$Date[0]
            );
        }elseif(preg_match($regDateSlash, $time)){
            $Date = explode('/',$time);
            return self::mktime(
                0,0,0,
                $Date[1],$Date[2],$Date[0]
