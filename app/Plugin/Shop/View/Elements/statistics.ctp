...
<div class="row">
    <div class="span3 box">
        ...
        <div class="box-body">
            <div class="box-item">
                ...
                <i><?php echo $this->Html->link($orderStats['newOrders'] . ' سفارش', array('controller' => 'Orders', 'action' => 'index', 'plugin' => 'Shop', 'type' => 2, 'status' => 0)); ?></i>
            </div>
            <div class="box-item">
                <span>بیشترین کالای فروش یافته</span><i><a><?php echo $orderStats['favoriteStuff']['name'] . ' (' .$orderStats['favoriteStuff']['count'].' مورد)'; ?></a></i>
            </div>
            <div class="box-item">
                <span>تعداد سفارش های امروز</span><i><?php echo $this->Html->link($orderStats['todayOrders'] . ' سفارش', array('controller' => 'Orders', 'action' => 'index', 'plugin' => 'Shop', 'type' => 2, 'status' => 0, 'date' => Jalali::date('Y-m-d'))); ?></i>
            </div>
    ...
    <div class="span3 box">
        <div class="box-header"><h2>سفارش های ارسال نشده</h2></div>
        <div class="box-body">
            <div class="box-item head">
                <span>شماره سفارش</span><i>مبلغ سفارش</i>
            </div>
            <?php if(!empty($orderStats['notSentFactors'])): ?>
                <?php foreach($orderStats['notSentFactors'] as $notSentFactors): ?>
                <div class="box-item">
                    <span><?php echo $this->Html->link($newFactor['FactorHead']['number'], array('controller' => 'Orders', 'action' => 'details', 'plugin' => 'Shop',  $newFactor['FactorHead']['id'])) ?></span>
                    <i><?php echo $this->Html->price($newFactor['FactorHead']['final_price']); ?></i>
                </div>
        ...
        <div class="box-footer"><?php echo $this->Html->link('بیشتر', array('controller' => 'Orders', 'action' => 'index', 'plugin' => 'Shop', 'type' => 2, 'status' => 1)); ?></div>
    </div>
</div>
<div class="row">
    <div class="span3 box">
